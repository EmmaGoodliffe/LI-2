...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
			...
			: "bg-s"} w-0 h-full rounded-sm transition-all duration-long`);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 21, 0, 558);
    			add_location(p, file$3, 22, 0, 585);
    			attr_dev(button, "class", "btn");
    			add_location(button, file$3, 24, 0, 668);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Auth extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { authed: 0, home: 2 });
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 77, 4, 2972);
    			attr_dev(button, "class", "btn");
    			add_location(button, file$2, 80, 4, 3020);
    			attr_dev(div, "class", "duration-short");
    			add_location(div, file$2, 76, 2, 2923);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t17 = text("Find tracks");
    			t18 = space();
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			add_location(h2, file$2, 50, 0, 2093);
    			add_location(p0, file$2, 51, 0, 2112);
    			attr_dev(p1, "class", "ta-label");
    			add_location(p1, file$2, 55, 4, 2273);
    			attr_dev(textarea0, "rows", "10");
    			add_location(textarea0, file$2, 56, 4, 2324);
    			attr_dev(div0, "class", "flex-auto");
    			add_location(div0, file$2, 54, 2, 2245);
    			attr_dev(button0, "class", "btn flex-auto md:hidden");
    			button0.disabled = button0_disabled_value = /*step*/ ctx[0] < 1 || 0 < /*progress*/ ctx[3] && /*progress*/ ctx[3] < 1;
    			add_location(button0, file$2, 58, 2, 2383);
    			attr_dev(div1, "class", "hidden md:flex arrow");
    			add_location(div1, file$2, 63, 2, 2532);
    			attr_dev(div2, "class", "flex md:hidden arrow");
    			add_location(div2, file$2, 64, 2, 2581);
    			attr_dev(p2, "class", "ta-label");
    			add_location(p2, file$2, 66, 4, 2658);
    			attr_dev(textarea1, "rows", "10");
    			add_location(textarea1, file$2, 67, 4, 2704);
    			attr_dev(div3, "class", "flex-auto");
    			add_location(div3, file$2, 65, 2, 2630);
    			attr_dev(div4, "class", "flex flex-col md:flex-row justify-evenly");
    			add_location(div4, file$2, 53, 0, 2188);
    			attr_dev(button1, "class", "btn hidden md:inline-block");
    			button1.disabled = button1_disabled_value = /*step*/ ctx[0] < 1 || 0 < /*progress*/ ctx[3] && /*progress*/ ctx[3] < 1;
    			add_location(button1, file$2, 70, 0, 2767);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button0, "click", /*click*/ ctx[5], false, false, false),
    					listen_dev(textarea1, "input", /*textarea1_input_handler*/ ctx[8]),
    					listen_dev(button1, "click", /*click*/ ctx[5], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*step, progress*/ 9 && button0_disabled_value !== (button0_disabled_value = /*step*/ ctx[0] < 1 || 0 < /*progress*/ ctx[3] && /*progress*/ ctx[3] < 1)) {
    			...
    			if (!current || dirty & /*step, progress*/ 9 && button1_disabled_value !== (button1_disabled_value = /*step*/ ctx[0] < 1 || 0 < /*progress*/ ctx[3] && /*progress*/ ctx[3] < 1)) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Tracks> was created with unknown prop '${key}'`);
    	});
    ...
    class Tracks extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { step: 0, token: 6, tracksText: 1 });
    ...
    /* src/Update.svelte generated by Svelte v3.42.3 */

    const { console: console_1 } = globals;
    const file$1 = "src/Update.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(/*error*/ ctx[3]);
    			attr_dev(p, "class", "text-bad duration-short");
    			add_location(p, file$1, 61, 2, 2378);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "3. Update";
    			t1 = space();
    			p = element("p");
    			p.textContent = "Update a playlist to include your tracks";
    			t3 = space();
    			create_component(bar.$$.fragment);
    			t4 = space();
    			input = element("input");
    			...
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			add_location(h2, file$1, 50, 0, 2059);
    			add_location(p, file$1, 51, 0, 2078);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Playlist name");
    			add_location(input, file$1, 53, 0, 2167);
    			add_location(br, file$1, 54, 0, 2243);
    			attr_dev(button, "class", "btn");
    			button.disabled = button_disabled_value = /*step*/ ctx[0] < 2 || 0 < /*progress*/ ctx[2] && /*progress*/ ctx[2] < 1;
    			add_location(button, file$1, 55, 0, 2250);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Update> was created with unknown prop '${key}'`);
    	});
    ...
    class Update extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { step: 0, token: 5, tracksText: 6 });
    ...
    function create_fragment(ctx) {
    	...
    	function update_step_binding(value) {
    		/*update_step_binding*/ ctx[6](value);
    	}
    	...
    	if (/*step*/ ctx[1] !== void 0) {
    		update_props.step = /*step*/ ctx[1];
    	}

    	update = new Update({ props: update_props, $$inline: true });
    	binding_callbacks.push(() => bind(update, 'step', update_step_binding));
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 38, 6, 1626);
    			add_location(h1, file, 38, 2, 1622);
    			add_location(li0, file, 40, 4, 1680);
    			add_location(li1, file, 43, 4, 1730);
    			add_location(li2, file, 46, 4, 1800);
    			add_location(ol, file, 39, 2, 1671);
    			attr_dev(main, "class", "text-center sm:w-11/12 lg:w-5/6 mx-auto");
    			add_location(main, file, 37, 0, 1565);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(ol, t3);
    			append_dev(ol, li2);
    			mount_component(update, li2, null);
    			current = true;
    		},
    		p: function update$1(ctx, [dirty]) {
    			...
    			if (dirty & /*token*/ 4) update_changes.token = /*token*/ ctx[2];
    			if (dirty & /*tracksText*/ 8) update_changes.tracksText = /*tracksText*/ ctx[3];

    			if (!updating_step_1 && dirty & /*step*/ 2) {
    				updating_step_1 = true;
    				update_changes.step = /*step*/ ctx[1];
